...
def main() -> None:
    ...
    (OUTPUT_DIRECTORY / "taxonomy.json").write_text(json.dumps(taxonomy, ensure_ascii=False, indent=1))
    (OUTPUT_DIRECTORY / "strategies.json").write_text(json.dumps(strategies, ensure_ascii=False, indent=1))
    print(f"wrote {OUTPUT_DIRECTORY/'taxonomy.json'} and {OUTPUT_DIRECTORY/'strategies.json'}")
